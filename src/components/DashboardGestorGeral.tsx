        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              { label: 'Relatório Financeiro', icon: <BarChart3    className="w-5 h-5" />, acao: () => setSecaoAtiva('relatorio-financeiro'), bgL: '#ccfbf1', bgD: '#134e4a', cor: '#0d9488' },
            ].map(a => (
                      ...
                      <tr key={a.id}
                        ...
                        <td className="px-4 py-3.5">
                          {a.tem_ficha ? (
                            ...
                            // ── BOTÃO CLICÁVEL: abre FormularioMatricula pré-preenchido ──
                            <button
                        ...
                        <td className="px-4 py-3.5">
                          {a.tem_contrato ? (
                            ...
                            // ── BOTÃO CLICÁVEL: abre EmissaoContratos com ficha pré-selecionada ──
                            <button
                              onClick={() => navegarComContexto(
                        ...
                        <td className="px-4 py-3.5">
                          {!a.tem_ficha ? (
                            ...
                            // ── BOTÃO CLICÁVEL: abre DocumentosRecebidos na ficha do aluno ──
                            <button
                              onClick={() => navegarComContexto(
    ...
    switch (secaoAtiva) {
      ...
      case 'emissao-contratos':
        return (
          <EmissaoContratos
            onVoltar={voltarParaAlunos}
            // Contexto: se veio de "Criar Contrato", passa fichaId pré-selecionada
            fichaIdInicial={
      ...
      case 'documentos-recebidos':
        return (
          <DocumentosRecebidos
            onVoltar={voltarParaAlunos}
            // Contexto: se veio de "Ver Docs", abre direto na ficha do aluno
            fichaIdInicial={
