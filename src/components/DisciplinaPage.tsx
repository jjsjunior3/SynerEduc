    ...
    export function DisciplinaPage({
      ...
      if (!disciplina || !turma) {
        return (
          <div className="min-h-full bg-gray-50 flex items-center justify-center"> {/* Alterado min-h-screen para min-h-full */}
      ...
      return (
        <div
          className={`min-h-full flex flex-col ${ // Alterado min-h-screen para min-h-full
            darkMode ? "bg-gray-950 text-gray-100" : "bg-gray-50 text-gray-900"
          }`}
        >
          {/* HEADER */}
          <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-20">
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between"> {/* Adicionado max-w-7xl mx-auto para limitar o header */}
            ...
            <div className="border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
              <nav className="max-w-7xl mx-auto px-4 md:px-6 flex items-center gap-1 overflow-x-auto"> {/* Adicionado max-w-7xl mx-auto para limitar as abas */}
                {menuItens.map((item) => {
          ...
          {/* CONTEÚDO DAS ABAS */}
          <main className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-6 py-6"> {/* Adicionado max-w-7xl mx-auto para limitar o conteúdo principal */}
            {/* ABA CONTEÚDO */}
            {abaAtiva === "conteudo" && (
